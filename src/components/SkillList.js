    ...
    <div style={{ marginBottom: '20px' }}>
        ...
        <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
          ...
          {activeTeam.map(student => {
            ...
            // --- TARGETING LOGIC FIX ---
            // 1. Must be a different student (cannot target self if source set)
            // 2. Cannot target 'Special' students (User Request)
            const isTargetCandidate = targetingSource && 
                                      student.id !== targetingSource.id && 
                                      student.role !== 'Special'; 
            ...
            return (
              <button 
                ...
                disabled={(!targetingSource && !canAfford) || (!targetingSource && isActivating) || (targetingSource && !isTargetCandidate)}
                ...
                style={{ 
                  ...
                  opacity: (targetingSource && !isTargetCandidate) ? 0.3 : (isActivating ? 0.7 : 1),
